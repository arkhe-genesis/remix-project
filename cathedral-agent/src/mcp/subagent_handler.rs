...
pub async fn handle_spawn_subagent(
    ...
    let response = json!({
        ...
        "created_at": subagent.identity.created_at,
...
pub async fn handle_list_subagents(
    ...
    let subagents: Vec<crate::orchestrator::subagent_spawner::Subagent> = spawner.list_active().await;
...
pub async fn handle_terminate_subagent(
    ...
    let subagent: crate::orchestrator::subagent_spawner::Subagent = spawner.terminate(id).await
        .map_err(|e| MCPError {
            code: -32000,
...
pub async fn handle_execute_subagent(
    ...
    let cost_cap = args.get("cost_cap").and_then(|v: &serde_json::Value| v.as_f64());
