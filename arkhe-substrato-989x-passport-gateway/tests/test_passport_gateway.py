...
class MockSession:
    ...
    def set_get_return_values(self, values):
        self._get_return_values = values
...
async def test_get_passport_score_success(gateway, mock_session):
    ...
    mock_session.set_get_return_values([resp])
...
async def test_is_human_high_score(gateway, mock_session):
    ...
    mock_session.set_get_return_values([score_resp, stamps_resp])
    gateway._session = mock_session
...
async def test_is_human_api_error_with_orcid(gateway, mock_session):
    ...
    mock_session.set_get_return_values([score_resp, orcid_resp])
    gateway._session = mock_session
...
def test_fair_score_empty():
    fair = FAIRMetadata(dpid="", access_protocol="", license="", data_format="", ontology="", version="")
