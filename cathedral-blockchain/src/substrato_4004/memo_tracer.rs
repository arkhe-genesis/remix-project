...
use std::sync::Arc;
use crate::substrato_4004::mock::{EventStore, CrossChainEmitterV2, Action, OrchestratorEvent, TracerError, Address};
use sha2::Digest;
...
impl MemoTracer {
    ...
    pub async fn index_memo_event(
        ...
        // Emite cross-chain
        self.cross_chain_emitter.emit_cross_chain(event).await.map_err(|_| TracerError)?;
